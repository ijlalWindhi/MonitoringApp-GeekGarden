      ...
      <div className='bg-purple-100 h-screen'>
        ...
        <div className="mt-10 w-full"> 
          <div className='ml-20'>
            ...
            <button className="bg-green-500 text-white text-lg font-medium px-3 py-2 rounded-xl my-3" id="btn-blue" onClick={() => this.handleAdd()}>+ Tambah Paket</button>
          </div>
        ...
        <Modal show={this.state.isModalOpen} onHide={this.handleClose} centered>
          ...
          <Form onSubmit={e => this.handleSave(e)}>
            ...
            <Modal.Footer>
              <Button className='bg-purple-400' type="submit" id="blue">
                Save
              </Button>
            </Modal.Footer>
          </Form>
